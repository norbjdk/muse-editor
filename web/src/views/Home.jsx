                ...
                <div className={`min-w-9/12 max-w-full mx-auto`}>
                    <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8`}>
                        {features.map((feature, index) => (
                            <div key={index} className={`flex items-center gap-4 bg-[#365603]/90 border cursor-pointer border-[#CCC5B9]/10 p-3 rounded-lg hover:border-[#365603]/50 transition-all group hover:-translate-y-2`}>
