...
import com.muse.editor.model.event.user.LoginFailedEvent;
import com.muse.editor.model.event.user.LoginSuccessEvent;
import com.muse.editor.model.event.user.LogoutEvent;
import com.muse.editor.model.event.view.OpenLoginDialogEvent;
