            ...
            {projects.length === 0 ? (
              ...
              <div className="flex flex-col gap-2">
                {projects.map((p) => (
                  <div
                    key={p.id}
                    className="flex items-center gap-4 px-4 py-3 bg-white/30 rounded-xl border border-stone-300/40 hover:bg-white/40 transition-colors"
                  >
                    <div className="w-10 h-10 rounded-lg bg-slate-700/10 border border-stone-300/40 flex items-center justify-center text-stone-400 text-lg select-none flex-shrink-0">
                      𝄞
                    </div>
